...
deploy-ganche:
		forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(GANACHE_RPC_URL) --private-key $(GANACHE_PRIVATE_KEY)  --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
